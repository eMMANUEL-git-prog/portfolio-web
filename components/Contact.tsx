  ...
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-white dark:bg-gray-900">
        ...
        <div
          className="absolute top-1/2 right-1/4 text-gray-400/8 dark:text-gray-600/12 animate-pulse"
          style={{ animationDelay: "2s" }}
        >
          <Server className="w-12 h-12" />
        </div>
        <div
          className="absolute top-1/3 left-1/4 text-gray-400/8 dark:text-gray-600/12 animate-bounce"
        ...
        <div
          className="absolute top-2/3 right-10 text-sm text-gray-400/12 dark:text-gray-600/15 font-mono animate-pulse select-none pointer-events-none"
